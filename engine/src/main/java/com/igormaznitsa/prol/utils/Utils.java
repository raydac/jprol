...
public final class Utils {
     ...
     * @throws com.igormaznitsa.prol.exceptions.ProlInstantiationErrorExceptionit it will be thrown if the term is a noninstantiated variable.
     ...
     * @throws com.igormaznitsa.prol.exceptions.ProlInstantiationErrorExceptionit it will be thrown if the term is a non instantiaded variable
     */
